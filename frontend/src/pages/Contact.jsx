              ...
              <div className="flex items-start gap-4 p-5 rounded-xl border border-slate-700 bg-slate-800/50 hover:bg-slate-800 transition-all">
                ...
                <div>
                  ...
                  <div className="text-slate-300 mt-3 space-y-5 text-sm sm:text-base">
                    <p className="leading-relaxed"><strong className="text-white">Hyderabad:</strong><br />3rd Floor, Advant Towers, <span className="whitespace-nowrap">Plot No 4, </span>Road No 7, <br />Kakatiya Hills, Madhapur,<br />Hyderabad, Telangana - 500081</p>
